...
<div class="wrapper">
          ...
          <div class="col-12">
           ...
           @isset($msg)
            <div class="card-header">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <tr>
                    <td colspan="8"><a href='/o' title='New' data-toggle='tooltip'><i class='fa fa-plus'></i></a></td>
                  </tr>
                 @isset($orders)
	        ...
	        <tr>
	            ...
	            <td>
	            <a href='/u{{$order->user->id}}' title='Edit' data-toggle='tooltip'><i class='fa fa-link'>{{$order->user->email}}</i></a>
	            </td>
	            <td>{{$order->start}}</td>
	            <td>{{$order->end}}</td>
	            <td>{{($order->status == 0) ? 'Active' : 'Inactive'}}</td>
	            <td>
	            	<a href='/os{{$order->id}}' title='Delete' data-toggle='tooltip'><i class='fa fa-trash'></i></a>
	            </td>
	        </tr>
	        @endforeach
	        @endisset
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; Dao Vinh Loc - 2022 <a href="https://adminlte.io">Library Management</a>.</strong> All rights reserved.
  </footer>
