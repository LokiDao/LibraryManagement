              ...
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="code" name="code" placeholder="Order's Code" required>
                  </div>
                    ...
                    <input name="start" type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" inputmode="numeric" required>
                  </div>
                        </div>
                        <div class="form-group">
                            <label>End</label>
                    ...
                    <input name="end" type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" inputmode="numeric" required>
                        </div>
                        <div class="form-group">
                            <label>Books</label>
