          ...
          <div class="col-12">
           ...
           @isset($msg)
            <div class="card-header">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <tr>
                    <td colspan="8"><a href='/b' title='New' data-toggle='tooltip'><i class='fa fa-plus'></i></a></td>
                  </tr>
                 @isset($books)
	        ...
	        <tr>
	            ...
	            <td>
	            	<a href='/bs{{$book->id}}' title='Delete' data-toggle='tooltip'><i class='fa fa-trash'></i></a>
	            </td>
	        </tr>
	        @endforeach
	        @endisset
