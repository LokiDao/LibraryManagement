    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" name="search-book-form" method="get" action="/bf">
           ...
           @isset($msg)
            <div class="card-header">
              ...
              <div class="card-header">
				...
				<p align="right">
              <a href='/bs{{$book->id}}' title='Delete' data-toggle='tooltip'><i class='fa fa-trash' style="font-size:26px"></i></a>
				</p>
              </div>
              ...
              @csrf
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" class="form-control" required value="{{$book->name}}">
                        </div>
                   <div class="form-group">
                ...
                <div class="card-footer">
                  ...
                  <span> </span>
                  <a href='/b{{$book->id}}' title='Cancel' data-toggle='tooltip'><i class='fa fa-window-close' style="font-size:30px"></i></a>
                </div>
