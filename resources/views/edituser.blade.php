           ...
           @isset($msg)
            <div class="card-header">
              ...
              <div class="card-header">
                ...
                <p align="right">
              <a href='/us{{$user->id}}' title='Delete' data-toggle='tooltip'><i class='fa fa-trash' style="font-size:26px"></i></a>
				</p>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              @csrf
                <div class="card-body">
                  <div class="form-group">
                            ...
                            <input name="password" class="form-control" required value="{{$user->password}}" hidden>
                        </div>
                        <div class="form-group">
                            <label>Name</label>
